...
<section class="py-5 section-2" id ="serv">
   ...
   <div class="container">
     <div class="row">
       ...
       <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-0 shadow">
         <a class= "a1" href="cvstyle1.php"><img src="images/cvT2.jpg" href="#" class="card-img-top" alt="..."> </a>
         </div>
       </div>
       <!-- Team Member 3 -->
      <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-0 shadow">
         <a class= "a1" href="cvstyle1.php"><img src="images/cvT3.jpg" href="#" class="card-img-top" alt="..."> </a>
         </div>
       </div>
       <!-- Team Member 4 -->
       <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-0 shadow">
         <a class= "a1" href="cvstyle1.php"><img src="images/cvT4.jpg" href="#" class="card-img-top" alt="..."> </a>
         </div>
       </div>
     <!-- /.row -->
